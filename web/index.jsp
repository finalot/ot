...
<body class="animsition">
	...
	<section class="slide1" style="margin-top:-40px;z-index:2;">
		<div class="wrap-slick1">
			<div class="slick1">
				<div class="item-slick1 item1-slick1" style="background-image: url(images/main_top.jpg);size:100%;height:700px;">
				...
				<div class="item-slick1 item2-slick1" style="background-image: url(images/main_top1.jpg);height:700px;">
					<div class="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
				...
				<div class="item-slick1 item3-slick1" style="background-image: url(images/main_top2.jpg);height:700px;">
					<div class="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
