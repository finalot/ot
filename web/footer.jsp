	...
	<div class="btn-back-to-top bg0-hov" id="myBtn" style="height:320px; background:black; margin-bottom:10%;">
		...
		<button class="header-icon1 js-show-header-dropdown" style="width:88%;height:12%;background:snow;margin-top:-650%;border-radius:10%;" >
					...
					<div class="header-wrapicon2 m-r-13" style="width:75%;height:75%;">
						<img style="border-radius:10%;" src="images/icons/icon-header-02.png" onmouseover="this.src='images/icons/icon-header-02-2.png'"
		...
		<a class="symbol-btn-back-to-top" href="index.jsp" >
			<img style="border-radius:10%;" src="images/icons/icon-header-03.png" class="header-icon1" alt="ICON"
